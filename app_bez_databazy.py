...
from util import check_allowed_car_2, get_mode_db, write_csv, update_table, check_spz, free_places_db
import uuid
import os
import av
import time
        ...
        if mod == 1:
            ...
            if free_places > 0:
                ...
                if len(results) == 1:
                    ...
                    kontrola = check_allowed_car_2(license_plate_text)
